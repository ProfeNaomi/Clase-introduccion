...
const originalSlides = [
    { title: "Matemáticas", h3: "El lenguaje para entender el universo.", p: "", media: "/images/slide1.jpg", type: "image", alternate: false },
    { title: "Naomi Urrea", h3: "", p: "Profesora de matemáticas e ingeniera en ejecución industrial, pero antes que todo eso, una amante de las matemáticas, las ciencias y, por sobre todo, el conocimiento.", media: "/images/slide2.jpg", type: "image", alternate: true },
    { title: "Y a ti ¿Que te gusta?", h3: "Más allá del aula y los exámenes.", p: "¿Te has preguntado cómo funciona tu videojuego favorito o cómo se construyen los rascacielos? Las matemáticas son la herramienta secreta detrás de todo lo que amas.", media: "/images/slide3.jpg", type: "image", alternate: false },
    ...
    { title: "Participación", h3: "Tú eres el protagonista aquí.", p: "Aprender matemáticas es como aprender un deporte: para mejorar, ¡hay que jugar! Tu participación es vital para que la clase sea dinámica y divertida.", media: "/images/slide5.jpg", type: "image", alternate: false },
    ...
    { title: "Disciplina y Equipo", h3: "Juntos llegamos más lejos.", p: "Llegar a tiempo nos permite aprovechar cada minuto. El éxito en matemáticas suele ser el resultado de un buen trabajo en equipo.", media: "/images/slide7.webp", type: "image", alternate: false },
    { title: "Argumentar y comunicar", h3: "Pensar antes de actuar.", p: "Argumentar: Justificar pasos lógicos, defender una postura, evaluar el razonamiento de otros y usar contraejemplos. Comunicar: Usar el lenguaje matemático adecuado (tanto oral como escrito) para presentar soluciones, ideas y hallazgos con orden y claridad.", media: "/images/slide8.jpg", type: "image", alternate: true },
    ...
    { title: "Resolver problemas", h3: "Tu cerebro es un músculo.", p: "Analizar la situación, identificar la información relevante, diseñar una estrategia, aplicar conocimientos matemáticos, verificar su respuesta y, si es necesario, cambiar de estrategia. Se busca desarrollar la perseverancia y la capacidad de enfrentar desafíos.", media: "/images/slide11.jpg", type: "image", alternate: false },
    { title: "¿Por qué debemos estudiar matemáticas?", h3: "¿Qué te gustaría hacer cuando seas grande?", p: "", media: "/images/slide12.jpg", type: "image", alternate: true },
    { title: "Nueva Diapositiva", h3: "", p: "", media: "/images/slide1.jpg", type: "image", alternate: false }
];
